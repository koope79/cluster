...
def recognition():
    for i in range(9,13):
        ...
        cmd = 'cd /home/rock64/pocketsphinx-5prealpha/src/programs && sudo pocketsphinx_continuous -samprate 16000 -hmm /home/rock64/pocketsphinx-5prealpha/model/ru-model/zero_ru.cd_semi_4000 -jsgf /home/rock64/nikolayDC/cluster/gram/my_rus_pi.gram -dict /home/rock64/nikolayDC/cluster/gram/my_rus_pi_dict -infile /home/rock64/nikolayDC/cluster/{} -logfn /dev/null'.format(name_file)
